...
window.mergeLanguageTexts = function () {
  const text_bundle_en = {
    'RN.steps': {
      ...
      12: "idam koNda kIrththi mazhisaikku iRaivan * iNai adippOdhu adangum * idhayaththu irAmAnusan *** am poRpAdham enRum kadam koNdu irainjum thiru munivarkku anRik kAdhal seyyAth * thidam koNda gyAniyarkkE * adiyEN anbu seyvadhuvE *",
